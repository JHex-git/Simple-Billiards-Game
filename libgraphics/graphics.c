...
/*    RegisterWindowClass();*/
    ...
    wndcls.cbClsExtra = 0;
    wndcls.cbWndExtra = 0;
    wndcls.hbrBackground = NULL;// (HBRUSH)GetStockObject(WHITE_BRUSH);
...
static void InitColors(void)
{
    ...
    DefineColor("Purple", .5, 0, .5);
    DefineColor("DarkGreen", .1328, .6914, .2969);
    DefineColor("BackColor",.004, .2344, .4922);
    DefineColor("TableBrown",.59375, .297, 0);
    DefineColor("ButtColor", .5272,.9,.9);
}
